...
function renderRecentlyViewedList() {
    if (!recentlyViewedListElement || !noRecentCardsMessageElement) return;
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    recentlyViewedListElement = document.getElementById('recently-viewed-list'); // Added
    noRecentCardsMessageElement = document.getElementById('no-recent-cards-message'); // Added
